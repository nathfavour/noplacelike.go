...
// DocumentationHandler returns a handler that serves the API documentation
func DocumentationHandler() gin.HandlerFunc {
...
// JSONDocumentationHandler returns a handler that serves the API documentation as JSON
func JSONDocumentationHandler() gin.HandlerFunc {
	return func(c *gin.Context) {
		c.JSON(http.StatusOK, gin.H{
			"apiVersion": "v1",
			"categories": getAPIDocumentation(),
		})
	}
}

// getAPIDocumentation returns a list of all API categories and endpoints
func getAPIDocumentation() []APICategory {
	apiDocs := []APICategory{
		{
			Name:        "Clipboard",
			...
			Endpoints: []APIEndpoint{
				{
					...
					Example: "curl -X GET http://localhost:8000/api/v1/clipboard",
				},
				{
					Path:        "/api/v1/clipboard",
					Method:      "POST",
					...
					Example: "curl -X POST -H \"Content-Type: application/json\" -d '{\"text\":\"Hello from API\"}' http://localhost:8000/api/v1/clipboard",
				},
				{
					...
					Example: "curl -X GET http://localhost:8000/api/v1/clipboard/history",
				},
				{
					Path:        "/api/v1/clipboard/history",
					Method:      "DELETE",
					...
					Example: "curl -X DELETE http://localhost:8000/api/v1/clipboard/history",
				},
			},
		},
		{
			...
			Endpoints: []APIEndpoint{
				{
					...
					Example: "curl -X GET http://localhost:8000/api/v1/files",
				},
				{
					Path:        "/api/v1/files",
					Method:      "POST",
					...
					Example: "curl -X POST -F \"file=@local_file.txt\" http://localhost:8000/api/v1/files",
				},
				{
					...
					Example: "curl -X GET http://localhost:8000/api/v1/files/document.pdf -o downloaded.pdf",
				},
				{
					Path:        "/api/v1/files/:filename",
					Method:      "DELETE",
					...
					Example: "curl -X DELETE http://localhost:8000/api/v1/files/document.pdf",
				},
			},
		},
		{
			Name:        "Filesystem",
			Description: "Browse and access the filesystem",
			Endpoints: []APIEndpoint{
				{
					...
					Example: "curl -X GET \"http://localhost:8000/api/v1/filesystem/list?path=/home/user/Documents\"",
				},
				{
					...
					Example: "curl -X GET \"http://localhost:8000/api/v1/filesystem/content?path=/home/user/file.txt\"",
				},
			},
		},
		{
			...
			Endpoints: []APIEndpoint{
				{
					...
					Example: "curl -X POST -H \"Content-Type: application/json\" -d '{\"command\":\"ls -la\"}' http://localhost:8000/api/v1/shell/exec",
				},
				{
					...
					Example: "Accessible via WebSocket: ws://localhost:8000/api/v1/shell/stream?command=top",
				},
			},
		},
		{
			...
			Endpoints: []APIEndpoint{
				{
					...
					Example: "curl -X GET http://localhost:8000/api/v1/system/info",
				},
				{
					...
					Response: map[string]interface{}{
						"processes": []map[string]interface{}{
							{"pid": 1234, "name": "process1", "cpu": "2.5%", "memory": "150MB"},
						},
					},
					Example: "curl -X GET http://localhost:8000/api/v1/system/processes",
				},
				{
					...
					Example: "curl -X POST -H \"Content-Type: application/json\" -d '{\"title\":\"Alert\",\"message\":\"Server restart required\"}' http://localhost:8000/api/v1/system/notify",
				},
			},
		},
		{
			...
			Endpoints: []APIEndpoint{
				{
					...
					Example: "curl -X GET http://localhost:8000/api/v1/media/audio/devices",
				},
				{
					...
					Example: "Accessible via WebSocket: ws://localhost:8000/api/v1/media/audio/stream?device=default",
				},
				{
					...
					Example: "Accessible via WebSocket: ws://localhost:8000/api/v1/media/screen?quality=medium&fps=15",
				},
			},
		},
	}
...
// The interactive API documentation HTML template
    ...
    <script>
        async function loadDocs() {
            try {
                ...
                document.getElementById('apiContent').innerHTML = '<div class="error">Failed to load API documentation. Please try again later.</div>';
            }
        }
